      ...
      function ($scope, $rootScope, $state, $stateParams, Restangular) {
        ...
        $scope.saveNative = function() {
          try {
            ...
            baseRoleNativeVars.customPUT(vars, 'native' ,{d: 'json'}, {'Content-Type': 'text/plain'}).then(function() {
            ...
            $rootScope.message = { text: 'Native rolevars could be parsed: ' + (err.stack || String(err)), success: false };
          }
        };
